                ...
                <div class="container">
                    <div class="header-wrap header-space-between">
                        <div class="logo logo-width-1">
                            <a href="index.html"><img src="assets/imgs/theme/logo-default.png" alt="logo" /></a>
                        </div>
                            ...
                            <div class="header-action-2">
                                <div class="header-action-icon-2">
                                    <a href="shop-wishlist.html">
                                        <img class="svgInject" alt="wowy" src="assets/imgs/theme/icons/icon-heart.svg" />
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="wowy" src="assets/imgs/shop/thumbnail-1.jpg" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="page-login-register.html">
                                        <img alt="wowy" src="assets/imgs/theme/icons/icon-user.svg" />
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="header-wrap header-space-between position-relative">
                        <div class="logo logo-width-1 d-block d-lg-none">
                            <a href="index.html"><img src="assets/imgs/theme/logo-white.png" alt="logo" /></a>
                        </div>
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-desktop"></i>Computer & Office</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-cpu"></i>Consumer Electronics</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-diamond"></i>Jewelry & Accessories</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-home"></i>Home & Garden</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-high-heels"></i>Shoes</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-teddy-bear"></i>Mother & Kids</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"><i class="wowy-font-kite"></i>Outdoor fun</a>
                                    </li>
                                    <li>
                                        <ul class="more_slide_open" style="display: none">
                                            <li>
                                                <a href="shop-grid-right.html"><i class="wowy-font-desktop"></i>Beauty, Health</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"><i class="wowy-font-cpu"></i>Bags and Shoes</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"><i class="wowy-font-diamond"></i>Consumer Electronics</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"><i class="wowy-font-home"></i>Automobiles & Motorcycles</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block main-menu-light-white hover-boder hover-boder-white">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop-grid-right.html">Shop <i class="fa fa-chevron-down"></i></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a href="#">Single Product <i class="fa fa-chevron-right"></i></a>
                                                <ul class="level-menu">
                                    ...
                                    <li class="position-static">
                                        <a href="#">Mega menu <i class="fa fa-chevron-down"></i></a>
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img src="assets/imgs/banner/menu-banner.jpg" alt="wowy" /></a>
                                    ...
                                    <li>
                                        <a href="blog-category-grid.html">Blog <i class="fa fa-chevron-down"></i></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a href="#">Single Post <i class="fa fa-chevron-right"></i></a>
